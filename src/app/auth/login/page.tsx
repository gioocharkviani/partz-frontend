    ...
    <div className="min-h-screen bg-teal-wash flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-dark">{t('auth.loginTitle')}</h1>
          <p className="text-muted text-sm mt-1">{t('auth.loginSub')}</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 card-shadow">
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="field-label mb-2">{t('auth.email')}</label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative text-center">
              <span className="bg-white px-3 text-xs text-navy/40">{t('auth.orContinueWith')}</span>
            </div>
          </div>
